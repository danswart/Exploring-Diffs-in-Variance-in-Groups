...
ggplot2::ggplot(df_random, 
  ...
  ggplot2::labs(title = "Histogram of Random Uniform Universes", x = "Value", y = "Frequency")


ggplot2::ggplot(df_sequential, 
                ggplot2::aes(x = sequential_universe)) +
  ggplot2::geom_histogram(binwidth = 10, fill = "lightgreen", color = "black", alpha = 0.7) +
  ggplot2::labs(title = "Histogram of Sequential Universes", x = "Value", y = "Frequency")


ggplot2::ggplot(df_clustered, 
                ggplot2::aes(x = clustered_universe)) +
  ggplot2::geom_histogram(binwidth = 10, fill = "lightgreen", color = "black", alpha = 0.7) +
  ggplot2::labs(title = "Histogram of Clustered Universes", x = "Value", y = "Frequency")


ggplot2::ggplot(df_bimodal,
                ggplot2::aes(x = bimodal_universe)) +
  ggplot2::geom_histogram(binwidth = 10, fill = "lightgreen", color = "black", alpha = 0.7) +
  ggplot2::labs(title = "Histogram of Bi-Modal Universes", x = "Value", y = "Frequency")


ggplot2::ggplot(df_increasing_var_universe, 
                ggplot2::aes(x = increasing_var_universe)) +
  ggplot2::geom_histogram(binwidth = 10, fill = "lightgreen", color = "black", alpha = 0.7) +
  ggplot2::labs(title = "Histogram of Increasing Variance Universes", x = "Value", y = "Frequency")
...
for(size in base::unique(results_df$sample_size)) {
  ...
  test_results <- base::rbind(test_results, base::data.frame(
    ...
    p_value = base::round(f_test$p.value, 4),
    significant = base::ifelse(f_test$p.value < 0.05, "Yes", "No")
  ))
}


flextable::flextable(test_results) |>
  ...
  flextable::bg(bg = "palegreen", part = "header") |>
  flextable::bg(i = ~ significant == "Yes", j = "significant", bg = "yellow", part = "body") |>
  flextable::bg(i = ~ significant == "No", j = "significant", bg = "#FFB6C1", part = "body") |>
  flextable::align(j = c("sample_size", "p_value", "significant"), align = "center", part = "body") |>
  flextable::autofit()
...
#   ) |>
#   flextable::bg(bg = "palegreen", part = "header") |>
#   flextable::bg(i = ~ significant == "Yes", bg = "yellow", part = "body") |>
#   flextable::bg(i = ~ significant == "No", bg = "#FFB6C1", part = "body") |>
#   flextable::align(j = c("sample_size", "p_value", "significant"), align = "center", part = "body") |>
#   flextable::autofit()
