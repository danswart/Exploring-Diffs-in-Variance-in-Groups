---
title: "Random v Increasing Variance"
author: "Dan Swart"
date: "2025-04-28"
...
# Verify variance
var(random_universe)  # Should be around 83,000-84,000
var(high_var_universe)  # Should be much higher
```

# Random Universe v High Variance Universe
...
ggplot(results_df, aes(x = factor(sample_size), y = variance, color = universe_type)) +
  ...
  labs(
    ...
    subtitle = "Random v High Variance",
    x = "Sample Size",
    y = "Variance",
    color = "Universe Type"
  ) +
